...
def reformat_data(points, perc_values, temp_values, evap_values, disch_points, disch_values, number_days, dates, perc_file_path, disch_file_path,temp_file_path, evap_file_path, extent=(1, 1, 1, 1), spacing=100, power=1):
    ...
    for n in range(0, number_days):
        ...
        perc_points = [points[key] for key in set(perc_values.keys())]
        temp_points = [points[key] for key in set(temp_values.keys())]
        evap_points = [points[key] for key in set(evap_values.keys())]
