...
class BiLSTM_flat(nn.Module):
    def __init__(self, input_channels, input_size, hidden_size, output_size, num_layers=1, dropout=0.3):
        super(BiLSTM_flat, self).__init__()
        
        # Flatten spatial dimensions (height * width) into a single feature vector
        self.input_size = input_channels * input_size
